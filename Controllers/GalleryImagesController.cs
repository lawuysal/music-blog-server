...
namespace music_blog_server.Controllers
{
    ...
    {
        private readonly IGalleryImageRepsitory imageRepsitory;
        private readonly MusicBlogDbContext dbContext;

        public GalleryImagesController(IGalleryImageRepsitory imageRepsitory, MusicBlogDbContext dbContext)
        {
